...
int main()
{
    ...
    std::shared_ptr<Lidar_Simulation::Lidar_Utils> m_lidar_utils{nullptr};

    m_lidar_utils=std::make_shared<Lidar_Simulation::Lidar_Tool_Option>();

    m_lidar_utils->lidarPointsPrinter(m_lidar_points, size);
